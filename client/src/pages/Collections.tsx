...
const COLLECTIONS = [
  { id:'1', title:'Referências de UI',    count:24, thumb:['#7c6ef7','#4f8ef7','#3ecf8e','#f78c4f'] },
  { id:'2', title:'Leituras de UX',       count:18, thumb:['#e46ef7','#7c6ef7','#4f8ef7','#3ecf8e'] },
  { id:'3', title:'Dev Tools',            count:31, thumb:['#3ecf8e','#4f8ef7','#f78c4f','#e46ef7'] },
  { id:'4', title:'Inspirações de motion',count:12, thumb:['#f78c4f','#e46ef7','#7c6ef7','#3ecf8e'] },
  { id:'5', title:'Artigos para TCC',     count: 9, thumb:['#4f8ef7','#3ecf8e','#7c6ef7','#e46ef7'] },
]
